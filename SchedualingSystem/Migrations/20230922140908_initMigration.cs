        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentageDone = table.Column<double>(type: "float", nullable: false),
                    PercentageLeft = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskUser", x => new { x.EmployeesId, x.TasksId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_TaskUser_Users_EmployeesId",
